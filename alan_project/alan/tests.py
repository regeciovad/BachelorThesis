...
class ParserMethodTests(TestCase):
	...
	def test_parser_a(self):
		...
		output_expected = ['action[0, i] = s9', 'action[9, $] = r16', 'pravidlo 16: <factor> -> i',
			'action[7, $] = r14', 'pravidlo 14: <term> -> <factor>', 'action[6, $] = r11',
			'pravidlo 11: <expression> -> <term>', 'action[5, $] = r8', 
	...
	def test_parser_a_less(self):
		...
		output_expected = ['action[0, i] = s9', 'action[9, r] = r16', 'pravidlo 16: <factor> -> i',
			'action[7, r] = r14', 'pravidlo 14: <term> -> <factor>', 'action[6, r] = r11',
			'pravidlo 11: <expression> -> <term>', 'action[5, r] = r8', 
